...
subprocess.Popen([my_env["python_executable"],Path("web_scrapping","scheduler_main.py")],env=my_env)
subprocess.run([my_env["python_executable"],Path("django_wcapp","django_wcapp","manage.py"),"runserver",my_env["django_server_address_port"]],env=my_env)